...
//            Bukkit.broadcastMessage("the entity is looking at smth");
...
//        }
    ...
    public static Location getLeftSideFromEntityView(final Location location, Entity entity, double distance) {
        return location.clone().add(Vectors.getLeftSideNormalisedVector(entity).multiply(distance));
    }
    ...
    public static Location getRightSideFromEntityView(final Location location, Entity entity, double distance) {
        return location.clone().add(Vectors.getRightSideNormalisedVector(entity).multiply(distance));
    }

    public static Location getMainHandLocation(final Entity entity) {
        double y = 1.2 ;

            return getRightSide(entity.getLocation(), .55).add(0, y, 0)
                    .add(entity.getLocation().getDirection().multiply(0.8));

    }

    public static Location getOffHandLocation(final Entity entity) {
        double y = 1.2 ;
