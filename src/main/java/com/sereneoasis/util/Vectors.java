...
public class Vectors {
    ...
    public static Vector getVectorToMainHand(Entity entity) {
        double y = 1.2;
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0, y, 0), Locations.getMainHandLocation(entity));
    }


    public static Vector getVectorToOffHand(Entity entity) {
        double y = 1.2;
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0, y, 0), Locations.getOffHandLocation(entity));
    }

    public static Vector getLeftSideNormalisedVector(Entity entity) {
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0,entity.getHeight()-0.5,0), Locations.getLeftSide(entity.getLocation().add(0,entity.getHeight()-0.5,0), 1));
    }

    public static Vector getRightSideNormalisedVector(Entity entity) {
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0,entity.getHeight()-0.5,0), Locations.getRightSide(entity.getLocation().add(0,entity.getHeight()-0.5,0), 1));
    }

    public static Vector getLeftSide(Entity entity, double length) {
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0,entity.getHeight()-0.5,0), Locations.getLeftSide(entity.getLocation().add(0,entity.getHeight()-0.5,0), length));
    }

    public static Vector getRightSide(Entity entity, double length) {
        return Vectors.getDirectionBetweenLocations(entity.getLocation().add(0,entity.getHeight()-0.5,0), Locations.getRightSide(entity.getLocation().add(0,entity.getHeight()-0.5,0), length));
    }
    ...
    public static double getPitchDiff(Vector previousVec, Vector newVec, Entity entity) {
        return Math.toRadians(entity.getLocation().setDirection(newVec).getPitch() - entity.getLocation().setDirection(previousVec).getPitch());
    }

    public static double getYawDiff(Vector previousVec, Vector newVec, Entity entity) {
        return Math.toRadians(entity.getLocation().setDirection(newVec).getYaw() - entity.getLocation().setDirection(previousVec).getYaw());
    }

    public static float getYaw(Vector vec, Entity entity) {
        return entity.getLocation().setDirection(vec).getYaw();
    }

    public static float getPitch(Vector vec, Entity entity) {
        return entity.getLocation().setDirection(vec).getPitch();
    }
