...
//    private Set<TempBlock> sourceTempBlocks = new HashSet<>();
    ...
    public BlockExplodeSphere(Entity entity, String name, Location startLoc, double increment) {
        super(entity, name);
    ...
    public BlockExplodeSphere(Entity entity, String name, Location startLoc, double radius, double increment) {
        super(entity, name);
