...
import com.sereneoasis.ability.abilities.MasterAbility;
...
public class BlockAbilities {
    ...
    public static void handleBouncingShootBlockFromLoc(MasterAbility masterAbility, ShootBlockFromLoc shootBlockFromLoc) {
        masterAbility.getHelpers().put(shootBlockFromLoc, status -> {
            switch (status) {
                case SHOT -> {
                    shootBlockFromLoc.getBlock().rotate(Vectors.getYaw(shootBlockFromLoc.getDir(), masterAbility.getEntity()), Vectors.getPitch(shootBlockFromLoc.getDir(), masterAbility.getEntity()));
...
//                        masterAbility.getsEntity().addCooldown(masterAbility.getName(), masterAbility.getCooldown());
