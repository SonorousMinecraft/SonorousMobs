...
public class BlockRingAroundPoint extends CoreAbility {
    ...
    public BlockRingAroundPoint(Entity entity, String user, Location startLoc, Material type, double ringSize, int orientation, int rotatePerTick, boolean clockwise) {
        super(entity, user);
