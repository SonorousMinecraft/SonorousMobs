package com.sereneoasis.ability.utilities.blocks.forcetype.sourcing;
...
public class SourceBlockToLoc extends CoreAbility {
    ...
    public SourceBlockToLoc(Entity entity, String user, double distanceToStop, int amount, Block source, Location targetLoc) {
        super(entity, user);
