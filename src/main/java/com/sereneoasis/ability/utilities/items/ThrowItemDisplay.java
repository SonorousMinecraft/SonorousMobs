package com.sereneoasis.ability.utilities.items;
...
public class ThrowItemDisplay extends CoreAbility {
    ...
    public ThrowItemDisplay(Entity entity, String name, Location loc, Vector dir, Material material, double width, double length, boolean stick, boolean diagonal, boolean sphere) {
        super(entity, name);
        ...
        this.oldPitch = dir.toLocation(entity.getWorld()).getPitch();
        start();
    }
