...
public class ShootItemDisplay extends CoreAbility {
    ...
    public ShootItemDisplay(Entity entity, String name, Location loc, Vector dir, Material material, double width, double length, boolean stick, boolean diagonal, boolean sphere) {
        super(entity, name);
